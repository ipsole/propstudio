...
import { JSONStorageProvider, SupabaseStorageProvider } from './storage';

const app = express();
const port = process.env.PORT || 3001;

// Set USE_SUPABASE=true in .env to switch to Supabase storage
...
if (db instanceof JSONStorageProvider) {
  console.log("Using local JSON storage adapter.");
